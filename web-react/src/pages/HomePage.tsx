  ...
  return (
    <div className="console">
      <div style={{ marginBottom: 'var(--space-5)' }}>
        <h1 className="console-heading" style={{ fontSize: 22 }}>
          PDF Toolkit
        </h1>
...
function ToolCard({ tool, onClick }: { tool: ToolDef; onClick: () => void }) {
  return (
    ...
    >
      ...
      <div style={{ fontWeight: 700, fontSize: 'var(--font-size-sm)' }}>{tool.title}</div>
      <div style={{ color: 'var(--text-2)', fontSize: 'var(--font-size-xs)' }}>{tool.description}</div>
    </button>
  );
}
